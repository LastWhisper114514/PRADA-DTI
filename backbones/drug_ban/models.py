...
from backbones.drug_ban.ban import BANLayer
from torch.nn.utils.weight_norm import weight_norm
#from Dti.Dti_cnn import MolecularGCN_muti,fea_Cnn_simple
...
class DrugBANbackbone(nn.Module):
    def __init__(self, config):
        super(DrugBANbackbone, self).__init__()
        print(config.keys())
        ...
        #expand_sizes = config["PROTEIN"]["EXPAND_SIZES"]
        ...
        self.bcn = weight_norm(
            ...
            name='h_mat', dim=None)
        self.mlp_classifier = MLPDecoder(mlp_in_dim, mlp_hidden_dim, mlp_out_dim, binary = 2) # binary=out_binary)

    def forward(self, v_p, bg_d, mode="train"):
